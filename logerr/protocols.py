"""
Protocol definitions for comparison operations.

These protocols define the interfaces that comparable types must implement
to support various comparison operations with Result and Option types.
"""
...
@runtime_checkable
class SupportsComparison(SupportsDunderLT, SupportsDunderLE, SupportsDunderGT, SupportsDunderGE, Protocol):
